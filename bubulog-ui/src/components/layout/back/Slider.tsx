...
export const Slider = () => {
  ...
  return (
    <Sidebar>
      <SidebarContent>
        <SidebarGroup>
          <SidebarGroupLabel className="mb-3 p-4 bg-foreground h-20">
            <div className="size-full flex items-center gap-x-4">
              <svg
                stroke="currentColor"
                fill="#5ed3f3"
                strokeWidth="0"
              ...
              <h1 className="font-bold text-lg text-background">布布管理后台</h1>
            </div>
          </SidebarGroupLabel>
